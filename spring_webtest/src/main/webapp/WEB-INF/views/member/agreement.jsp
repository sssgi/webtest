...
<div class="container">
<h1 class="col-sm-offset-2 col-sm-10" align="center">약관동의</h1>
 <form class="form-horizontal" action="create" method="post" onsubmit="return send();" name="frm">
   
  <div class="form-group">
    <label class="control-label col-sm-1" for="content"></label>
    <div class="col-sm-10"> 
    <textarea cols="100" rows="20" id="content" name="content" class="form-control">Cummunity 서비스약관 (2005. 7. 18 부터 유효) 
...
본 약관은 2005. 7. 18. 부터 적용하고, 2004. 10. 11.부터 적용되던 종전의 약관은 본 약관으로 대체합니다.  
  ...
  <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
      ...
      <button class="btn-default btn" type="submit">회원가입</button>
